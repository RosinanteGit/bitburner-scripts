  ...
  while (ns.hacknet.numNodes() > 0) {
    ...
    while (ns.getServerMoneyAvailable('home') >= reserveMoney) {
      ...
      /*
            ...
            */
      if (
        ns.hacknet.getLevelUpgradeCost(ns.hacknet.numNodes() - 1, n) ===
          Infinity &&
        ns.hacknet.getRamUpgradeCost(ns.hacknet.numNodes() - 1, n) ===
          Infinity &&
        ...
        ns.hacknet.getRamUpgradeCost(ns.hacknet.numNodes() - 1, n) >
          ns.hacknet.getPurchaseNodeCost() &&
        ns.hacknet.getCoreUpgradeCost(ns.hacknet.numNodes() - 1, n) >
          ns.hacknet.getPurchaseNodeCost()
      ) {
        ns.hacknet.purchaseNode()
        ns.print(
