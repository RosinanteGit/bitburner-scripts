 ...
 */
export async function exec (ns, script, targetHost, threads, args) {
  ...
  if (
    ns.getScriptRam(script, 'home') * threads >
    ns.getServerMaxRam(targetHost) - ns.getServerUsedRam(targetHost)
  ) {
    return -4
  }
