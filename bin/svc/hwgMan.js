...
export async function main (ns) {
  while (true) {
    ...
    if (
      ns.getServerSecurityLevel(config.hackTarget) >
      ns.getServerMinSecurityLevel(config.hackTarget)
    ) {
      ...
      ns.getServerMoneyAvailable(config.hackTarget) <
      ns.getServerMaxMoney(config.hackTarget)
    ) {
